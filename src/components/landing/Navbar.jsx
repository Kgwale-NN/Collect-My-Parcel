      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a href="#for-drivers" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Drivers</a>
            <Link to="/track" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Track</Link>
            <Link to="/dashboard">
              <Button variant="ghost" size="sm">Dashboard</Button>
            </Link>
            <Button size="sm" className="rounded-md px-5" onClick={handleRequestPickup}>Request Pickup</Button>
          </div>

          <button className="md:hidden h-9 w-9 rounded-md border flex items-center justify-center" onClick={() => setOpen(!open)}>
        ...
        {open && (
          <div className="md:hidden pb-4 space-y-2">
            ...
            <a href="#for-drivers" className="block py-2 text-sm text-muted-foreground" onClick={() => setOpen(false)}>Drivers</a>
            ...
            <Button size="sm" className="w-full rounded-md" onClick={() => { setOpen(false); handleRequestPickup(); }}>Request Pickup</Button>
          </div>
        )}
      </div>
    </nav>
